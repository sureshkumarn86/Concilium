<?php 
 $pageTitle='Board of Directors';
     ...
     ?>
<h3>President - Prof. Dr. Felix Wilfred , INDIA</h3>
<p>
<img class="director float-left" alt="Board ofDirector" src="resource/image/board-directors/Felix_Wilfred.gif"/>

 ...
 *             Encode Explorer
 *
 *             Author / Autor : Marek Rei (marek Ã¤t siineiolekala dot net)
 *
 ...
 *                  vÃµivad probleemid tekkida, eriti piltide kuvamisega.
 *
 ***************************************************************************/
...
//
// AlgvÃ¤Ã¤rtustame muutujad. Ã„ra muuda.
//
...
//
// Vali sobiv keel. Allpool on nÃ¤ha vÃµimalikud valikud. Vaikimisi: en
//
...
// Levinumad pildifailide tÃ¼Ã¼bid on toetatud (jpeg, png, gif).
...
//
// Mobillidele mÃµeldud kasutajaliides. true/false
// Vaikimisi: true
// 
...
//
// Mobiilidele mÃµeldud kasutajaliides avaneb automaatselt. true/false
// Vaikimisi: false
//
...
//
// Kui sÃ¼gavalt alamkataloogidest suurust nÃ¤itav script faile otsib? 
// MÃ¤Ã¤ra see nullist suuremaks, kui soovid kogu kasutatud ruumi suurust kuvada.
// Vaikimisi: 0
//
...
//
// Kas kuvatakse lehe pÃ¤is? true/false
// Vaikimisi: true;
//
...
//
$_CONFIG['main_title'] = "Download Contents";//Encode Explorer";
...
// Tuleb panna sobivaks, kui tÃ¤pitÃ¤htedega tekib probleeme. Vaikimisi: UTF-8
//
...
// NÃ¤iteks: CONFIG['hidden_dirs'] = array("ikoonid", "kaustanimi", "teinekaust");
//
...
// NB! MÃ¤rgitud nimega failid ja kaustad varjatakse kÃµigis alamkaustades.
//
...
//
// MÃ¤Ã¤ra kas lehe nÃ¤gemiseks peab sisse logima.
// 'false' tÃ¤hendab, et leht on avalik
// 'true' tÃ¤hendab, et kasutaja peab sisestama parooli (vaata allpool).
//
...
//
// Kasutajanimed ja paroolid, lehele ligipÃ¤Ã¤su piiramiseks.
// NÃ¤iteks: $_CONFIG['users'] = array(array("user1", "pass1"), array("user2", "pass2"));
// VÃµimalik lehte kaitsta ka ainult Ã¼ldise parooliga.
// NÃ¤iteks: $_CONFIG['users'] = array(array(null, "pass"));
// Kui Ã¼htegi kasutajat mÃ¤rgitud ei ole, siis parooli ei kÃ¼sita.
//
...
// NÃ¤iteks: $_CONFIG['upload_dirs'] = array("./myuploaddir1/", "./mydir/upload2/");
// Kausta asukoht peab olema mÃ¤Ã¤ratud pÃµhikausta suhtes, algama "./" ja lÃµppema "/" mÃ¤rgiga.
// KÃµik kaustad mÃ¤rgitute all on automaatselt kaasa arvatud.
// Kui nimekiri on tÃ¼hi (vaikimisi), siis on kÃµikidesse kaustadesse failide lisamine lubatud.
//
...
//
// MIME failitÃ¼Ã¼bid mis on uploadimiseks lubatud.
// NÃ¤iteks: $_CONFIG['upload_allow_type'] = array("image/png", "image/gif", "image/jpeg");
//
...
// Kui mÃ¤Ã¤ratud, siis saadetakse sellele aadressile e-mail iga kord kui keegi lisab uue faili vÃµi kausta.
//
...
//
// Logifail. Kui mÃ¤Ã¤ratud, siis kirjutatakse kaustade ja failide avamise kohta logi faili.
// NÃ¤iteks: $_CONFIG['log_file'] = ".log.txt";
//
...
//
// Asukoht serveris. Tavaliselt ei ole vaja siia midagi panna kuna script leiab ise Ãµige asukoha. 
// MÃµnes serveris tuleb piirangute tÃµttu see aadress ise teistsuguseks mÃ¤Ã¤rata.
// See fail peaks asuma serveris aadressil [AADRESS]/index.php
// Aadress vÃµib olla nÃ¤iteks "/www/data/www.minudomeen.ee/minunimi"
//
...
//
// Suured failid. Kui sul on failiruumis vÃ¤ga suured failid (>4GB), siis on see vajalik
// faili suuruse Ãµigeks mÃ¤Ã¤ramiseks. Vaikimisi: false
//
...
//
// KÃ¼psise/sessiooni nimi. 
// Anna sellele originaalne vÃ¤Ã¤rtus kui soovid samas ruumis kasutada mitut koopiat
// ning ei taha, et toimuks andmete jagamist nende vahel.
// VÃ¤Ã¤rtus tohib sisaldada ainult tÃ¤hti ja numbreid. NÃ¤iteks: MYSESSION1
//
...
$_TRANSLATIONS["al"] = array(
	...
	"total_used_space" => "Memorija e pÃ«rdorur total",
	"free_space" => "Memorija e lirÃ«",
	"password" => "FjalÃ«kalimi",
	"upload" => "Ngarko skedarÃ«",
	"failed_upload" => "Ngarkimi i skedarit dÃ«shtoi!",
	"failed_move" => "LÃ«vizja e skedarit nÃ« udhÃ«zuesin e saktÃ« deshtoi!",
	"wrong_password" => "FjalÃ«kalimi i Gabuar!!",
...
$_TRANSLATIONS["et"] = array(
	...
	"new_dir_failed" => "Kausta loomine ebaÃµnnestus",
	"chmod_dir_failed" => "Kausta Ãµiguste muutmine ebaÃµnnestus",
	"unable_to_read_dir" => "Unable to read directory",
	"location" => "Asukoht",
	"root" => "Peakaust"
);
...
$_TRANSLATIONS["fi"] = array(
	...
	"password" => "Salasana",
	"upload" => "LisÃ¤Ã¤ tiedosto",
	"failed_upload" => "Tiedoston lisÃ¤ys epÃ¤onnistui!",
	"failed_move" => "Tiedoston siirto kansioon epÃ¤onnistui!",
	"wrong_password" => "VÃ¤Ã¤rÃ¤ salasana",
	"make_directory" => "Uusi kansio",
	"new_dir_failed" => "Uuden kansion luonti epÃ¤onnistui!",
	"chmod_dir_failed" => "Kansion kÃ¤yttÃ¤jÃ¤oikeuksien muuttaminen epÃ¤onnistui!",
	"unable_to_read_dir" => "Kansion sisÃ¤ltÃ¶Ã¤ ei voi lukea.",
	"location" => "Paikka",
	"root" => "Juurihakemisto",
	"log_file_permission_error" => "Ohjelman ei ole sallittu kirjoittaa lokiin.",
	"upload_not_allowed" => "Ohjelman asetukset eivÃ¤t salli tiedoston lisÃ¤Ã¤mistÃ¤ tÃ¤hÃ¤n kansioon.",
	"upload_dir_not_writable" => "Kansioon tallentaminen epÃ¤onnistui.",
	"mobile_version" => "MobiilinÃ¤kymÃ¤",
	"standard_version" => "Tavallinen nÃ¤kymÃ¤",
	"page_load_time" => "Sivu ladattu %.2f ms:ssa",
	"wrong_pass" => "VÃ¤Ã¤rÃ¤ kÃ¤yttÃ¤jÃ¤tunnus tai salasana",
	"username" => "KÃ¤yttÃ¤jÃ¤tunnus",
	"log_in" => "Kirjaudu sisÃ¤Ã¤n",
	"log_out" => "Kirjaudu ulos",
	"upload_type_not_allowed" => "TÃ¤mÃ¤n tiedostotyypin lisÃ¤Ã¤minen on estetty.",
	"del" => "Poista"
);
...
$_TRANSLATIONS["de"] = array(
	...
	"chmod_dir_failed" => "VerÃ¤nderung der Zugriffsrechte des Ordners fehlgeschlagen",
	"unable_to_read_dir" => "Unable to read directory",
	"location" => "Location",
	"root" => "Root"
);
...
$_TRANSLATIONS["el"] = array(
	"file_name" => "ÎŒÎ½Î¿Î¼Î± Î±Ï�Ï‡ÎµÎ¯Î¿Ï…",
	"size" => "ÎœÎ­Î³ÎµÎ¸Î¿Ï‚",
	"last_changed" => "Î¤Ï�Î¿Ï€Î¿Ï€Î¿Î¹Î·Î¼Î­Î½Î¿",
	"total_used_space" => "Î§Ï�Î·ÏƒÎ¹Î¼Î¿Ï€Î¿Î¹Î·Î¼Î­Î½Î¿Ï‚ Ï‡ÏŽÏ�Î¿Ï‚",
	"free_space" => "Î•Î»ÎµÏ�Î¸ÎµÏ�Î¿Ï‚ Ï‡ÏŽÏ�Î¿Ï‚",
	"password" => "Î•Î¹ÏƒÎ¬Î³ÎµÏ„Î±Î¹ ÎºÏ‰Î´Î¹ÎºÏŒ",
	"upload" => "Î¦ÏŒÏ�Ï„Ï‰ÏƒÎ·",
	"failed_upload" => "Î‘Ï€Î¿Ï„Ï…Ï‡Î¯Î± Ï†ÏŒÏ�Ï„Ï‰ÏƒÎ·Ï‚ Î±Ï�Ï‡ÎµÎ¯Î¿Ï…!",
	"failed_move" => "Î‘Ï€Î¿Ï„Ï…Ï‡Î¯Î± Î¼ÎµÏ„Î±Ï†Î¿Ï�Î¬Ï‚ Î±Ï�Ï‡ÎµÎ¯Î¿Ï… ÏƒÏ„Î¿Î½ ÎºÎ±Ï„Î¬Î»Î»Î·Î»Î¿ Ï†Î¬ÎºÎµÎ»Î¿!",
	"wrong_password" => "Î›Î¬Î¸Î¿Ï‚ ÎºÏ‰Î´Î¹ÎºÏŒÏ‚",
	"make_directory" => "Î”Î·Î¼Î¹Î¿Ï…Ï�Î³Î¯Î± Î½Î­Î¿Ï… Ï†Î±ÎºÎ­Î»Î¿Ï…",
	"new_dir_failed" => "Î‘Ï€Î¿Ï„Ï…Ï‡Î¯Î± Î´Î·Î¼Î¹Î¿Ï…Ï�Î³Î¯Î±Ï‚ Î½Î­Î¿Ï… Ï†Î±ÎºÎ­Î»Î¿Ï…",
	"chmod_dir_failed" => "Î‘Ï€Î¿Ï„Ï…Ï‡Î¯Î± Ï„Ï�Î¿Ï€Î¿Ï€Î¿Î¯Î·ÏƒÎ·Ï‚ Î´Î¹ÎºÎ±Î¹Ï‰Î¼Î¬Ï„Ï‰Î½ Ï†Î±ÎºÎ­Î»Î¿Ï…",
	"unable_to_read_dir" => "Unable to read directory",
	"location" => "Location",
	"root" => "Root"
);
...
$_TRANSLATIONS["hu"] = array(
	"file_name" => "FÃ¡jl nÃ©v",
	"size" => "MÃ©ret",
	"last_changed" => "UtolsÃ³ mÃ³dosÃ­tÃ¡s",
	"total_used_space" => "Ã–sszes elfoglalt terÃ¼let",
	"free_space" => "Szabad terÃ¼let",
	"password" => "JelszÃ³",
	"upload" => "FeltÃ¶ltÃ©s",
	"failed_upload" => "A fÃ¡jl feltÃ¶ltÃ©se nem sikerÃ¼lt!",
	"failed_move" => "A fÃ¡jl mozgatÃ¡sa nem sikerÃ¼lt!",
	"wrong_password" => "HibÃ¡s jelszÃ³",
	"make_directory" => "Ãšj mappa",
	"new_dir_failed" => "A mappa lÃ©trehozÃ¡sa nem sikerÃ¼lt",
	"chmod_dir_failed" => "A mappa jogainak megvÃ¡ltoztatÃ¡sa nem sikerÃ¼lt",
	"unable_to_read_dir" => "A mappa nem olvashatÃ³",
	"location" => "Hely",
	"root" => "GyÃ¶kÃ©r",
	"log_file_permission_error" => "A log fÃ¡jl Ã­rÃ¡sa jogosultsÃ¡gi okok miatt nem sikerÃ¼lt.",
	"upload_not_allowed" => "Ebbe a mappÃ¡ba a feltÃ¶ltÃ©s nem engedÃ©lyezett.",
	"upload_dir_not_writable" => "A mappa nem Ã­rhatÃ³.",
	"mobile_version" => "Mobil nÃ©zet",
	"standard_version" => "Web nÃ©zet",
	"page_load_time" => "LetÃ¶ltÃ©si id? %.2f ms",
	"wrong_pass" => "Rossz felhasznÃ¡lÃ³nÃ©v vagy jelszÃ³",
	"username" => "FelhasznÃ¡lÃ³nÃ©v",
	"log_in" => "BelÃ©pÃ©s",
	"upload_type_not_allowed" => "A fÃ¡jltÃ­pus feltÃ¶ltÃ©se tiltott."
);
...
$_TRANSLATIONS["pt_BR"] = array(
	...
	"total_used_space" => "Total de espaÃ§o utilizado",
	"free_space" => "EspaÃ§o livre",
	"password" => "Senha",
	"upload" => "Enviar",
	"failed_upload" => "Falha ao enviar o arquivo!",
	"failed_move" => "Falha ao mover o arquivo para o diretÃ³rio correto!",
	"wrong_password" => "Senha errada",
	"make_directory" => "Nova pasta",
	"new_dir_failed" => "Falha ao criar diretÃ³rio",
	"chmod_dir_failed" => "Falha ao mudar os privilÃ©gios do diretÃ³rio",
	"unable_to_read_dir" => "NÃ£o foi possÃ­vel ler o diretÃ³rio",
	"location" => "LocalizaÃ§Ã£o",
	"root" => "RaÃ­z",
	"log_file_permission_error" => "O script nÃ£o tem permissÃ£o para escrever o arquivo de log.",
	"upload_not_allowed" => "A configuraÃ§Ã£o do script nÃ£o permite envios neste diretÃ³rio.",
	"upload_dir_not_writable" => "NÃ£o hÃ¡ permissÃ£o para escrita neste diretÃ³rio.",
	"mobile_version" => "VersÃ£o MÃ³vel",
	"standard_version" => "VersÃ£o PadrÃ£o",
	"page_load_time" => "PÃ¡gina carregada em %.2f ms",
	"wrong_pass" => "Nome de usuÃ¡rio ou senha errados",
	"username" => "Nome de UsuÃ¡rio",
	"log_in" => "Log in",
	"upload_type_not_allowed" => "NÃ£o Ã© permitido envio de arquivos deste tipo."
);
...
$_TRANSLATIONS["ru"] = array(
    ...
    "size" => "Ð Ð°Ð·Ð¼ÐµÑ€",
    "last_changed" => "ÐŸÐ¾Ñ�Ð»ÐµÐ´Ð½ÐµÐµ Ð¸Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ðµ",
    "total_used_space" => "Ð’Ñ�ÐµÐ³Ð¾ Ð¸Ñ�Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ð½Ð¾",
    "free_space" => "Ð¡Ð²Ð¾Ð±Ð¾Ð´Ð½Ð¾",
    "password" => "ÐŸÐ°Ñ€Ð¾Ð»ÑŒ",
    "upload" => "Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ°",
    "failed_upload" => "Ð�Ðµ ÑƒÐ´Ð°Ð»Ð¾Ñ�ÑŒ Ð·Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð»!",
    "failed_move" => "Ð�Ðµ ÑƒÐ´Ð°Ð»Ð¾Ñ�ÑŒ Ð¿ÐµÑ€ÐµÐ¼ÐµÑ�Ñ‚Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð» Ð² Ð½ÑƒÐ¶Ð½ÑƒÑŽ Ð¿Ð°Ð¿ÐºÑƒ!",
    "wrong_password" => "Ð�ÐµÐ²ÐµÑ€Ð½Ñ‹Ð¹ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ",
    "make_directory" => "Ð�Ð¾Ð²Ð°Ñ� Ð¿Ð°Ð¿ÐºÐ°",
    "new_dir_failed" => "Ð�Ðµ ÑƒÐ´Ð°Ð»Ð¾Ñ�ÑŒ Ñ�Ð¾Ð·Ð´Ð°Ñ‚ÑŒ Ð¿Ð°Ð¿ÐºÑƒ",
    "chmod_dir_failed" => "Ð�Ðµ ÑƒÐ´Ð°Ð»Ð¾Ñ�ÑŒ Ð¸Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ð¿Ñ€Ð°Ð²Ð° Ð´Ð¾Ñ�Ñ‚ÑƒÐ¿Ð° Ðº Ð¿Ð°Ð¿ÐºÐµ",
    "unable_to_read_dir" => "Ð�Ðµ Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ Ð¿Ñ€Ð¾Ñ‡Ð¸Ñ‚Ð°Ñ‚ÑŒ Ð¿Ð°Ð¿ÐºÑƒ",
    "location" => "Ð Ð°Ñ�Ð¿Ð¾Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ",
    "root" => "ÐšÐ¾Ñ€Ð½ÐµÐ²Ð°Ñ� Ð¿Ð°Ð¿ÐºÐ°",
    "log_file_permission_error" => "Ð¡ÐºÑ€Ð¸Ð¿Ñ‚ Ð½Ðµ Ð¸Ð¼ÐµÐµÑ‚ Ð¿Ñ€Ð°Ð² Ð´Ð»Ñ� Ð·Ð°Ð¿Ð¸Ñ�Ð¸ Ð»Ð¾Ð³Ð° Ñ„Ð°Ð¹Ð»Ð°.",
    "upload_not_allowed" => "Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ° Ð² Ñ�Ñ‚Ñƒ Ð¿Ð°Ð¿ÐºÑƒ Ð·Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½Ð° Ð² Ð½Ð°Ñ�Ñ‚Ñ€Ð¾Ð¹ÐºÐ°Ñ… Ñ�ÐºÑ€Ð¸Ð¿Ñ‚Ð°",
    "upload_dir_not_writable" => "Ð’ Ñ�Ñ‚Ñƒ Ð¿Ð°Ð¿ÐºÑƒ Ð·Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½Ð° Ð·Ð°Ð¿Ð¸Ñ�ÑŒ",
    "mobile_version" => "ÐœÐ¾Ð±Ð¸Ð»ÑŒÐ½Ñ‹Ð¹ Ð²Ð¸Ð´",
    "standard_version" => "ÐžÐ±Ñ‹Ñ‡Ð½Ñ‹Ð¹ Ð²Ð¸Ð´",
    "page_load_time" => "Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð° Ð·Ð°Ð³Ñ€ÑƒÐ¶ÐµÐ½Ð° Ð·Ð° %.2f Ð¼Ñ�.",
    "wrong_pass" => "Ð�ÐµÐ²ÐµÑ€Ð½Ð¾Ðµ Ð¸Ð¼Ñ� Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ� Ð¸Ð»Ð¸ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ",
    "username" => "Ð˜Ð¼Ñ� Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ�",
    "log_in" => "Ð’Ð¾Ð¹Ñ‚Ð¸",
    "upload_type_not_allowed" => "Ð­Ñ‚Ð¾Ñ‚ Ñ‚Ð¸Ð¿ Ñ„Ð°Ð¹Ð»Ð° Ð·Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½Ð¾ Ð·Ð°Ð³Ñ€ÑƒÐ¶Ð°Ñ‚ÑŒ"
);

// Slovensky
$_TRANSLATIONS["sk"] = array(
	"file_name" => "Meno sÃºboru",
	"size" => "Ve?kos?",
	"last_changed" => "PoslednÃ¡ zmena",
	"total_used_space" => "PouÅ¾itÃ© miesto celkom",
	"free_space" => "Vo?nÃ© miesto",
	"password" => "Heslo",
	"upload" => "Nahranie sÃºborov",
	"failed_upload" => "Chyba nahrÃ¡vania sÃºboru!",
	"failed_move" => "Nepodarilo sa presunÃº? sÃºbor do vybranÃ©ho adresÃ¡ra!",
	"wrong_password" => "NeplatnÃ© heslo!",
	"make_directory" => "NovÃ½ prie?inok",
	"new_dir_failed" => "Nepodarilo sa vytvori? adresÃ¡r!",
	"chmod_dir_failed" => "Nepodarilo sa zmeni? prÃ¡va adresÃ¡ra!",
	"unable_to_read_dir" => "NemÃ´Å¾em ?Ã­ta? adresÃ¡r",
...
$_TRANSLATIONS["es"] = array(
	...
	"size" => "Medida",
	"last_changed" => "Ultima modificaciÃƒÂ³n",
	...
	"wrong_password" => "ContraseÃƒÂ±a incorrecta",
	"make_directory" => "New dir",
	"new_dir_failed" => "Failed to create directory",
	"chmod_dir_failed" => "Failed to change directory rights",
	"unable_to_read_dir" => "Unable to read directory",
...
$_TRANSLATIONS["tr"] = array(
	...
	"password" => "Sifre",
	"upload" => "YÃ¼kleyen",
	"failed_upload" => "Hatali dosya yÃ¼klemesi!",
...
if($this->files)
{
	...
	foreach ($this->files as $file)
	{
		...
		print "<td class=\"name\">\n";
		print "\t\t<a target=\"_ccontents\" href=\"".$this->location->getDir(false, true, false, 0).$file->getNameEncoded()."\"";

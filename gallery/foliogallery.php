...
$itemsPerPage        = '20';    // number of images per page if not already specified in ajax mode 
	    ...
	    for( $i=$start; $i<$start + $numPerPage; $i++ )
		{
			...
			{  
				...
				<div class="thumb-wrapper">
					<div class="thumb">
					   <a class="showAlb" rel="<?php echo $albums[$i]; ?>" href="<?php echo rtrim($_SERVER['PHP_SELF'],".php"); ?>?album=<?php echo urlencode($albums[$i]); ?>">
